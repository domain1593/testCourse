...
public class ChoucairAcademyStepDefinitions {
    ...
    public void thatBrandonWantsToLearnAtTheAcademyChoucair(List<AcademyChoucairData> academyChoucairData) {
    ...
    public void heFindsTheCourseCalledRecursosAutomatizacionBancolombia(List<AcademyChoucairData> academyChoucairData) {
        OnStage.theActorInTheSpotlight().should(GivenWhenThen.seeThat(Answer.toThe(academyChoucairData.get(0).getStrCourseInside())));
    }
}
